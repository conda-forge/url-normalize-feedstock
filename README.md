...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/url-normalize-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12552&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/url-normalize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `url-normalize` can be installed with:

```
conda install url-normalize
```

It is possible to list all of the versions of `url-normalize` available on your platform with:
